...
dma_axi64_core0_ch dma_axi64_core0_ch1 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[1]),
...
dma_axi64_core0_ch dma_axi64_core0_ch2 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[2]),
...
dma_axi64_core0_ch dma_axi64_core0_ch3 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[3]),
...
dma_axi64_core0_ch dma_axi64_core0_ch4 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[4]),
...
dma_axi64_core0_ch dma_axi64_core0_ch5 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[5]),
...
dma_axi64_core0_ch dma_axi64_core0_ch6 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[6]),
...
dma_axi64_core0_ch dma_axi64_core0_ch7 (
            .clk(clk),
            .reset(reset),
            .scan_en(scan_en),
            .idle(ch_idle[7]),
